...
const Navbar = () => {
  ...
  const { setShowSearch, gitCartCount, logout } = useContext(ShopContext);
      ...
      <div className='flex items-center justify-between py-5 font-medium px-6'>
        ...
        <div className='flex items-center gap-5'>
          ...
          <Link to='/cart' className='relative'>
            ...
            <p className='absolute right-[-5px] bottom-[-5px] w-4 text-center leading-4 bg-black text-white aspect-square rounded-full text-[8px]'>{gitCartCount()}</p>
          </Link>
